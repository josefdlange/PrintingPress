		...
		<div class="book_record">
			...
			<table class="basicMetaTable">
				<tr>
					...
					<td>
						<span class="book_originalValue">Original Value: <xsl:value-of select="field[@name='listPrice']" /></span>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<span class="book_presentValue">Present Value: <xsl:value-of select="field[@name='currentValue']" /></span>
					</td>
				</tr>
				<tr>
					<td>
